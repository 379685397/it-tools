...
<template>
  <div>
    <c-buttons-select v-model:value="version" :options="versions" :label="t('tools.uuid-generator.versionLabel')" label-width="100px" mb-2 />
    ...
    <div v-if="version === 'v3' || version === 'v5'">
      <div>
        <c-buttons-select
          ...
          :label="t('tools.uuid-generator.namespaceKind')"
          label-width="100px"
          mb-2
        />
      </div>
