...
const rawJson = useStorage('json-prettify:raw-json', '{"message": "你好，世界", "foo": "bar"}');
...
<template>
  ...
  <n-form-item
    :label="t('tools.json-prettify.inputLabel')"
  ...
  >
    <c-input-text
      ...
      :placeholder="t('tools.json-prettify.inputPlaceholder')"
      rows="20"
      multiline
      autocomplete="off"
      autocorrect="off"
  ...
  <n-form-item :label="t('tools.json-prettify.outputLabel')">
