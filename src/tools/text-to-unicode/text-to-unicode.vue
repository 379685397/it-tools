...
<template>
  <c-card :title="$t('tools.text-to-unicode.cardTextToUnicode')">
    <c-input-text
      v-model:value="inputText"
      multiline
      :placeholder="t('tools.text-to-unicode.textPlaceholder')"
      :label="t('tools.text-to-unicode.textLabel')"
      autosize
      autofocus
      raw-text
  ...
  <c-card :title="$t('tools.text-to-unicode.cardUnicodeToText')">
    <c-input-text
      v-model:value="inputUnicode"
      multiline
      :placeholder="t('tools.text-to-unicode.unicodePlaceholder')"
      :label="t('tools.text-to-unicode.unicodeLabel')"
      autosize
      raw-text
