...
const { copy } = useCopy({ source: header });
</script>
...
<template>
  <div>
    ...
    <c-card>
      <n-statistic :label="t('tools.basic-auth-generator.authorizationHeaderLabel')" class="header">
    ...
    <div mt-5 flex justify-center>
      <c-button @click="copy(undefined, { notificationMessage: t('tools.basic-auth-generator.copiedHeader') })">
