...
const ipValidationRules = [
  {
    message: () => t('tools.ipv4-subnet-calculator.invalidAddress'),
...
const sections = computed(() => ([
  ...
  },
  {
    ...
    getValue: ({ base: ipAddress }: Netmask) => getIPClass({ ip: ipAddress }),
    undefinedFallback: t('tools.ipv4-subnet-calculator.unknownIpClass'),
  },
]));
